 ...
 */
function atto_youtube_params_for_js($elementid, $options, $fpoptions) {
	global $USER, $COURSE;
	//coursecontext
	...
	$params['usercontextid'] = $usercontextid;
		...
		if(!has_capability('atto/youtube:visible', $coursecontext) ){
			$disabled=true;
		 }
        ...
        $params['defaultflavor'] = get_config('atto_youtube','defaultflavor');
